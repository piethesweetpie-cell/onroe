...
const packageOptions = [
  {
    ...
    bullets: ["캐릭터 1명 일러스트 1장", "인물 중심 단독 컷", "시안 1개 제공", "수정 1회"],
  },
  {
    id: "standard",
    icon: "⭐",
    ...
    bullets: ["캐릭터 1명, 총 3장", "얼굴 1장, 전신 1장, 캐릭터 시트", "활용하기 좋은 앞, 뒤, 옆모습 캐릭터 시트 제공", "배경 없음 (투명·단색 배경)", "시안 2개 → 1개 선택 후 진행", "수정 2회"],
    badge: "BEST",
    emphasized: true,
  },
  {
    ...
    bullets: ["캐릭터 1명, 총 6장", "클로즈업1, 앞뒤옆1, 표정시트1", "배경을 포함한 장면", "바로 캐릭터화 가능한 데이터 프로필 샷", "포즈·액션 컷 1장", "시안 2개 → 1개 선택 후 진행", "수정 2회"],
  },
]
